 ...
 *
 * @author Foothill College, Bita M, Tanusree Debnath
 */
public class ShoppingBag 
{
	...
	{
		// TODO:  implemented the class GroceriesFileReader
		GroceriesFileReader reader = new GroceriesFileReader();

		// TODO: implemented the readFile() method which reads the CSV (Comma Seperated Value) file
